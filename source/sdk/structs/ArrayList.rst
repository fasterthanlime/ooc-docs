...
.. class:: ArrayList<T>
    ...
    .. staticmemberfunction:: new -> ArrayList<T>
        
    .. memberfunction:: init
        
    .. staticmemberfunction:: new~withCapacity (capacity: Int) -> ArrayList<T>
        
    .. memberfunction:: init~withCapacity (capacity: Int)
        
    .. staticmemberfunction:: new~withData (data: T*, size: Int) -> ArrayList<T>
