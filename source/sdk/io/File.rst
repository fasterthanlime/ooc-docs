...
.. class:: File
    ...
    .. memberfunction:: new (path: String) -> File
        
    
    .. memberfunction:: new~parentFile (parent: File, path: String) -> File
        
    
    .. memberfunction:: new~parentPath (parent, path: String) -> File
