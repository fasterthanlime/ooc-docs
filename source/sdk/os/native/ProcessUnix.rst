...
.. class:: ProcessUnix
    ...
    .. staticmemberfunction:: new~unix (args: :class:`~structs/ArrayList ArrayList<T>` ) -> :class:`~os/native/ProcessUnix ProcessUnix` 
        
    .. memberfunction:: init~unix (args: :class:`~structs/ArrayList ArrayList<T>` )
