...
.. class:: ProcessWin32
    ...
    .. staticmemberfunction:: new~win32 (args: :class:`~structs/ArrayList ArrayList<T>` ) -> :class:`~os/native/ProcessWin32 ProcessWin32` 
        
    .. memberfunction:: init~win32 (args: :class:`~structs/ArrayList ArrayList<T>` )
