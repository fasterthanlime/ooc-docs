...
.. class:: ThreadWin32
    ...
    .. staticmemberfunction:: new~win (runnable: :class:`~threading/Runnable Runnable` ) -> :class:`~threading/native/ThreadWin32 ThreadWin32` 
        
    .. memberfunction:: init~win (runnable: :class:`~threading/Runnable Runnable` )
