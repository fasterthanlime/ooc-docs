...
.. function:: gai_strerror (ecode: :cover:`~lang/types Int` ) -> :cover:`~lang/types String` 
...
.. cover:: FdSet
    ...
    :from: ``fd_set``
    .. memberfunction:: _set (fd: :cover:`~lang/types Int` , fdset: :cover:`~net/berkeley FdSet` *)
        
    .. memberfunction:: _isSet (fd: :cover:`~lang/types Int` , fdset: :cover:`~net/berkeley FdSet` *) -> :cover:`~lang/types Bool` 
        
    .. memberfunction:: _clr (fd: :cover:`~lang/types Int` , fdset: :cover:`~net/berkeley FdSet` *)
        
    .. memberfunction:: _zero (fdset: :cover:`~net/berkeley FdSet` *)
        
    .. memberfunction:: set (fd: :cover:`~lang/types Int` )
        
    .. memberfunction:: isSet (fd: :cover:`~lang/types Int` ) -> :cover:`~lang/types Bool` 
        
    .. memberfunction:: clr (fd: :cover:`~lang/types Int` )
